defmodule Legion.Messaging.Templatization.TemplateTest do
  ...
  test "changeset without user identifier" do
    changeset = Template.changeset(%Template{}, params_without_field(:user_id))

    refute changeset.valid?
  end

  test "changeset without name" do
    changeset = Template.changeset(%Template{}, params_without_field(:name))

    refute changeset.valid?
  end

  test "changeset without availability for apm" do
    changeset = Template.changeset(%Template{}, params_without_field(:is_available_for_apm?))

    assert changeset.valid?
  end

  test "changeset without availability for push" do
    changeset = Template.changeset(%Template{}, params_without_field(:is_available_for_push?))

    assert changeset.valid?
  end

  test "changeset without availability for mailing" do
    changeset = Template.changeset(%Template{}, params_without_field(:is_available_for_mailing?))

    assert changeset.valid?
  end

  test "changeset without availability for sms" do
    changeset = Template.changeset(%Template{}, params_without_field(:is_available_for_sms?))

    assert changeset.valid?
  end

  test "changeset without availability for platform" do
    changeset = Template.changeset(%Template{}, params_without_field(:is_available_for_platform))
