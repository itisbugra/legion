defmodule Legion.HTTP.Identity.Auth.SignIn.InstantiationController do
  ...
  action_fallback Legion.HTTP.FallbackController

  plug :put_view, Legion.HTTP.Identity.Auth.SignInView

  def create(conn, %{"username" => username, "password_hash" => password_hash, "one_shot" => one_shot}) do
