defmodule Mix.Tasks.Legion.Reg.Political do
  ...
  def put_subregion(name, region_name, code) do
    Repo.insert!(%Subregion{name: downcase_if_not_nil(name), 
  ...
  def put_intermediate_region(name, _, subregion_name, code) do
    Repo.insert!(%IntermediateRegion{name: downcase_if_not_nil(name),
  ...
  def put_country(name, two_letter, three_letter, iso_3166, region_name, subregion_name, intermediate_region_name) do
    Repo.insert!(%Country{name: downcase_if_not_nil(name),
