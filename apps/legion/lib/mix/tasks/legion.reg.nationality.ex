defmodule Mix.Tasks.Legion.Reg.Nationality do
  ...
  def put_nationality(abbreviation, country_name, preferred_demonym, second_demonym, third_demonym) do
    Repo.insert!(%Nationality{abbreviation: downcase_if_not_nil(abbreviation),
